...
public final class ActivityThirdBinding implements ViewBinding {
  ...
  private ActivityThirdBinding(@NonNull ConstraintLayout rootView, @NonNull TextView tvPerson) {
  ...
  public static ActivityThirdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityThirdBinding((ConstraintLayout) rootView, tvPerson);
    }
