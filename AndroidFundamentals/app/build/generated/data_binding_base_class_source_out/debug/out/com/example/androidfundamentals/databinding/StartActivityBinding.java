...
public final class StartActivityBinding implements ViewBinding {
  ...
  private StartActivityBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnStart) {
  ...
  public static StartActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new StartActivityBinding((ConstraintLayout) rootView, btnStart);
    }
